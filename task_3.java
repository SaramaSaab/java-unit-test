...
public class CheckIsAdultTest {
  ...
  public static Object[][] getTextData() {
	return new Object[][] {
		// Заполни массив тестовыми данными и ожидаемым 
результатом
        {17,false},
        {18,true},
        {19,true},
...
сообщение об ошибке
    assertEquals("Пользователю либо меньше 18 лет, либо он живет в стране, 
где совершеннолетие после 21 года", result, isAdult);
	}
}
